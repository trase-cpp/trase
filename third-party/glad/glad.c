/*
    ...
    OpenGL ES loader generated by glad 0.1.28 on Sat Oct 27 20:30:27 2018.
...
static int get_exts(void) {
  ...
  if (max_loaded_major < 3) {
    ...
    if (num_exts_i > 0) {
      char **tmp_exts_i = (char **)realloc(
          (void *)exts_i, (size_t)num_exts_i * (sizeof *exts_i));
      if (tmp_exts_i == NULL) {
        return 0;
      }
      exts_i = tmp_exts_i;
...
PFNGLRENDERBUFFERSTORAGEMULTISAMPLEANGLEPROC
    glad_glRenderbufferStorageMultisampleANGLE = NULL;
...
PFNGLRENDERBUFFERSTORAGEMULTISAMPLEAPPLEPROC
    glad_glRenderbufferStorageMultisampleAPPLE = NULL;
...
PFNGLFRAMEBUFFERTEXTURE2DDOWNSAMPLEIMGPROC
    glad_glFramebufferTexture2DDownsampleIMG = NULL;
PFNGLFRAMEBUFFERTEXTURELAYERDOWNSAMPLEIMGPROC
    glad_glFramebufferTextureLayerDownsampleIMG = NULL;
PFNGLRENDERBUFFERSTORAGEMULTISAMPLEIMGPROC
    glad_glRenderbufferStorageMultisampleIMG = NULL;
PFNGLFRAMEBUFFERTEXTURE2DMULTISAMPLEIMGPROC
    glad_glFramebufferTexture2DMultisampleIMG = NULL;
...
PFNGLRENDERBUFFERSTORAGEMULTISAMPLENVPROC
    glad_glRenderbufferStorageMultisampleNV = NULL;
...
PFNGLFRAMEBUFFERTEXTUREMULTISAMPLEMULTIVIEWOVRPROC
    glad_glFramebufferTextureMultisampleMultiviewOVR = NULL;
...
PFNGLFRAMEBUFFERFOVEATIONPARAMETERSQCOMPROC
    glad_glFramebufferFoveationParametersQCOM = NULL;
...
static void load_GL_ANGLE_framebuffer_blit(GLADloadproc load) {
  if (!GLAD_GL_ANGLE_framebuffer_blit)
    return;
  glad_glBlitFramebufferANGLE =
      (PFNGLBLITFRAMEBUFFERANGLEPROC)load("glBlitFramebufferANGLE");
}
static void load_GL_ANGLE_framebuffer_multisample(GLADloadproc load) {
  ...
  glad_glRenderbufferStorageMultisampleANGLE =
      (PFNGLRENDERBUFFERSTORAGEMULTISAMPLEANGLEPROC)load(
...
static void load_GL_ANGLE_translated_shader_source(GLADloadproc load) {
  ...
  glad_glGetTranslatedShaderSourceANGLE =
      (PFNGLGETTRANSLATEDSHADERSOURCEANGLEPROC)load(
...
static void load_GL_APPLE_framebuffer_multisample(GLADloadproc load) {
  ...
  glad_glRenderbufferStorageMultisampleAPPLE =
      (PFNGLRENDERBUFFERSTORAGEMULTISAMPLEAPPLEPROC)load(
          "glRenderbufferStorageMultisampleAPPLE");
  glad_glResolveMultisampleFramebufferAPPLE =
      (PFNGLRESOLVEMULTISAMPLEFRAMEBUFFERAPPLEPROC)load(
...
static void load_GL_APPLE_sync(GLADloadproc load) {
  ...
  glad_glClientWaitSyncAPPLE =
      (PFNGLCLIENTWAITSYNCAPPLEPROC)load("glClientWaitSyncAPPLE");
  glad_glWaitSyncAPPLE = (PFNGLWAITSYNCAPPLEPROC)load("glWaitSyncAPPLE");
  glad_glGetInteger64vAPPLE =
      (PFNGLGETINTEGER64VAPPLEPROC)load("glGetInteger64vAPPLE");
...
static void load_GL_IMG_bindless_texture(GLADloadproc load) {
  if (!GLAD_GL_IMG_bindless_texture)
    return;
  glad_glGetTextureHandleIMG =
      (PFNGLGETTEXTUREHANDLEIMGPROC)load("glGetTextureHandleIMG");
  glad_glGetTextureSamplerHandleIMG =
      (PFNGLGETTEXTURESAMPLERHANDLEIMGPROC)load("glGetTextureSamplerHandleIMG");
  glad_glUniformHandleui64IMG =
      (PFNGLUNIFORMHANDLEUI64IMGPROC)load("glUniformHandleui64IMG");
  glad_glUniformHandleui64vIMG =
      (PFNGLUNIFORMHANDLEUI64VIMGPROC)load("glUniformHandleui64vIMG");
  glad_glProgramUniformHandleui64IMG =
      (PFNGLPROGRAMUNIFORMHANDLEUI64IMGPROC)load(
          "glProgramUniformHandleui64IMG");
  glad_glProgramUniformHandleui64vIMG =
      (PFNGLPROGRAMUNIFORMHANDLEUI64VIMGPROC)load(
...
static void load_GL_IMG_framebuffer_downsample(GLADloadproc load) {
  ...
  glad_glFramebufferTexture2DDownsampleIMG =
      (PFNGLFRAMEBUFFERTEXTURE2DDOWNSAMPLEIMGPROC)load(
          "glFramebufferTexture2DDownsampleIMG");
  glad_glFramebufferTextureLayerDownsampleIMG =
      (PFNGLFRAMEBUFFERTEXTURELAYERDOWNSAMPLEIMGPROC)load(
...
static void load_GL_IMG_multisampled_render_to_texture(GLADloadproc load) {
  ...
  glad_glRenderbufferStorageMultisampleIMG =
      (PFNGLRENDERBUFFERSTORAGEMULTISAMPLEIMGPROC)load(
          "glRenderbufferStorageMultisampleIMG");
  glad_glFramebufferTexture2DMultisampleIMG =
      (PFNGLFRAMEBUFFERTEXTURE2DMULTISAMPLEIMGPROC)load(
...
static void load_GL_NV_copy_buffer(GLADloadproc load) {
  if (!GLAD_GL_NV_copy_buffer)
    return;
  glad_glCopyBufferSubDataNV =
      (PFNGLCOPYBUFFERSUBDATANVPROC)load("glCopyBufferSubDataNV");
}
static void load_GL_NV_coverage_sample(GLADloadproc load) {
  ...
  glad_glCoverageOperationNV =
      (PFNGLCOVERAGEOPERATIONNVPROC)load("glCoverageOperationNV");
}
...
static void load_GL_NV_framebuffer_multisample(GLADloadproc load) {
  ...
  glad_glRenderbufferStorageMultisampleNV =
      (PFNGLRENDERBUFFERSTORAGEMULTISAMPLENVPROC)load(
...
static void load_GL_NV_non_square_matrices(GLADloadproc load) {
  if (!GLAD_GL_NV_non_square_matrices)
    return;
  glad_glUniformMatrix2x3fvNV =
      (PFNGLUNIFORMMATRIX2X3FVNVPROC)load("glUniformMatrix2x3fvNV");
  glad_glUniformMatrix3x2fvNV =
      (PFNGLUNIFORMMATRIX3X2FVNVPROC)load("glUniformMatrix3x2fvNV");
  glad_glUniformMatrix2x4fvNV =
      (PFNGLUNIFORMMATRIX2X4FVNVPROC)load("glUniformMatrix2x4fvNV");
  glad_glUniformMatrix4x2fvNV =
      (PFNGLUNIFORMMATRIX4X2FVNVPROC)load("glUniformMatrix4x2fvNV");
  glad_glUniformMatrix3x4fvNV =
      (PFNGLUNIFORMMATRIX3X4FVNVPROC)load("glUniformMatrix3x4fvNV");
  glad_glUniformMatrix4x3fvNV =
      (PFNGLUNIFORMMATRIX4X3FVNVPROC)load("glUniformMatrix4x3fvNV");
}
...
static void load_GL_NV_viewport_array(GLADloadproc load) {
  if (!GLAD_GL_NV_viewport_array)
    return;
  glad_glViewportArrayvNV =
      (PFNGLVIEWPORTARRAYVNVPROC)load("glViewportArrayvNV");
  glad_glViewportIndexedfNV =
      (PFNGLVIEWPORTINDEXEDFNVPROC)load("glViewportIndexedfNV");
  glad_glViewportIndexedfvNV =
      (PFNGLVIEWPORTINDEXEDFVNVPROC)load("glViewportIndexedfvNV");
  glad_glScissorArrayvNV = (PFNGLSCISSORARRAYVNVPROC)load("glScissorArrayvNV");
  glad_glScissorIndexedNV =
      (PFNGLSCISSORINDEXEDNVPROC)load("glScissorIndexedNV");
  glad_glScissorIndexedvNV =
      (PFNGLSCISSORINDEXEDVNVPROC)load("glScissorIndexedvNV");
  glad_glDepthRangeArrayfvNV =
      (PFNGLDEPTHRANGEARRAYFVNVPROC)load("glDepthRangeArrayfvNV");
  glad_glDepthRangeIndexedfNV =
      (PFNGLDEPTHRANGEINDEXEDFNVPROC)load("glDepthRangeIndexedfNV");
...
static void
load_GL_OES_texture_storage_multisample_2d_array(GLADloadproc load) {
...
static void
load_GL_OVR_multiview_multisampled_render_to_texture(GLADloadproc load) {
  if (!GLAD_GL_OVR_multiview_multisampled_render_to_texture)
    return;
  glad_glFramebufferTextureMultisampleMultiviewOVR =
      (PFNGLFRAMEBUFFERTEXTUREMULTISAMPLEMULTIVIEWOVRPROC)load(
...
static void load_GL_QCOM_driver_control(GLADloadproc load) {
  if (!GLAD_GL_QCOM_driver_control)
    return;
  glad_glGetDriverControlsQCOM =
      (PFNGLGETDRIVERCONTROLSQCOMPROC)load("glGetDriverControlsQCOM");
  glad_glGetDriverControlStringQCOM =
      (PFNGLGETDRIVERCONTROLSTRINGQCOMPROC)load("glGetDriverControlStringQCOM");
  glad_glEnableDriverControlQCOM =
      (PFNGLENABLEDRIVERCONTROLQCOMPROC)load("glEnableDriverControlQCOM");
  glad_glDisableDriverControlQCOM =
      (PFNGLDISABLEDRIVERCONTROLQCOMPROC)load("glDisableDriverControlQCOM");
}
static void load_GL_QCOM_extended_get(GLADloadproc load) {
  if (!GLAD_GL_QCOM_extended_get)
    return;
  glad_glExtGetTexturesQCOM =
      (PFNGLEXTGETTEXTURESQCOMPROC)load("glExtGetTexturesQCOM");
  glad_glExtGetBuffersQCOM =
      (PFNGLEXTGETBUFFERSQCOMPROC)load("glExtGetBuffersQCOM");
  ...
  glad_glExtGetTexLevelParameterivQCOM =
      (PFNGLEXTGETTEXLEVELPARAMETERIVQCOMPROC)load(
          "glExtGetTexLevelParameterivQCOM");
  glad_glExtTexObjectStateOverrideiQCOM =
      (PFNGLEXTTEXOBJECTSTATEOVERRIDEIQCOMPROC)load(
...
static void load_GL_QCOM_extended_get2(GLADloadproc load) {
  if (!GLAD_GL_QCOM_extended_get2)
    return;
  glad_glExtGetShadersQCOM =
      (PFNGLEXTGETSHADERSQCOMPROC)load("glExtGetShadersQCOM");
  glad_glExtGetProgramsQCOM =
      (PFNGLEXTGETPROGRAMSQCOMPROC)load("glExtGetProgramsQCOM");
  glad_glExtIsProgramBinaryQCOM =
      (PFNGLEXTISPROGRAMBINARYQCOMPROC)load("glExtIsProgramBinaryQCOM");
  glad_glExtGetProgramBinarySourceQCOM =
      (PFNGLEXTGETPROGRAMBINARYSOURCEQCOMPROC)load(
...
static void load_GL_QCOM_framebuffer_foveated(GLADloadproc load) {
  ...
  glad_glFramebufferFoveationConfigQCOM =
      (PFNGLFRAMEBUFFERFOVEATIONCONFIGQCOMPROC)load(
          "glFramebufferFoveationConfigQCOM");
  glad_glFramebufferFoveationParametersQCOM =
      (PFNGLFRAMEBUFFERFOVEATIONPARAMETERSQCOMPROC)load(
          "glFramebufferFoveationParametersQCOM");
}
static void
load_GL_QCOM_shader_framebuffer_fetch_noncoherent(GLADloadproc load) {
  if (!GLAD_GL_QCOM_shader_framebuffer_fetch_noncoherent)
    return;
  glad_glFramebufferFetchBarrierQCOM =
      (PFNGLFRAMEBUFFERFETCHBARRIERQCOMPROC)load(
...
static void load_GL_QCOM_texture_foveated(GLADloadproc load) {
  ...
  glad_glTextureFoveationParametersQCOM =
      (PFNGLTEXTUREFOVEATIONPARAMETERSQCOMPROC)load(
...
static int find_extensionsGLES2(void) {
  ...
  GLAD_GL_ANDROID_extension_pack_es31a =
      has_ext("GL_ANDROID_extension_pack_es31a");
  ...
  GLAD_GL_ANGLE_framebuffer_multisample =
      has_ext("GL_ANGLE_framebuffer_multisample");
  GLAD_GL_ANGLE_instanced_arrays = has_ext("GL_ANGLE_instanced_arrays");
  GLAD_GL_ANGLE_pack_reverse_row_order =
      has_ext("GL_ANGLE_pack_reverse_row_order");
  GLAD_GL_ANGLE_program_binary = has_ext("GL_ANGLE_program_binary");
  GLAD_GL_ANGLE_texture_compression_dxt3 =
      has_ext("GL_ANGLE_texture_compression_dxt3");
  GLAD_GL_ANGLE_texture_compression_dxt5 =
      has_ext("GL_ANGLE_texture_compression_dxt5");
  ...
  GLAD_GL_APPLE_framebuffer_multisample =
      has_ext("GL_APPLE_framebuffer_multisample");
  ...
  GLAD_GL_ARM_shader_framebuffer_fetch =
      has_ext("GL_ARM_shader_framebuffer_fetch");
  ...
  GLAD_GL_IMG_texture_compression_pvrtc =
      has_ext("GL_IMG_texture_compression_pvrtc");
  GLAD_GL_IMG_texture_compression_pvrtc2 =
  ...
  GLAD_GL_NV_explicit_attrib_location =
      has_ext("GL_NV_explicit_attrib_location");
  ...
  GLAD_GL_NV_texture_compression_s3tc_update =
      has_ext("GL_NV_texture_compression_s3tc_update");
  ...
  GLAD_GL_OVR_multiview_multisampled_render_to_texture =
      has_ext("GL_OVR_multiview_multisampled_render_to_texture");
  ...
  GLAD_GL_QCOM_shader_framebuffer_fetch_noncoherent =
      has_ext("GL_QCOM_shader_framebuffer_fetch_noncoherent");
  GLAD_GL_QCOM_shader_framebuffer_fetch_rate =
      has_ext("GL_QCOM_shader_framebuffer_fetch_rate");
  GLAD_GL_QCOM_texture_foveated = has_ext("GL_QCOM_texture_foveated");
  GLAD_GL_QCOM_texture_foveated_subsampled_layout =
      has_ext("GL_QCOM_texture_foveated_subsampled_layout");
